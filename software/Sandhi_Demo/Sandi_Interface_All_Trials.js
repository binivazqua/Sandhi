...
function Start_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Start_3Components)
...
function Instrucciones_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instrucciones_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Start_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Start_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Instrucciones_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instrucciones_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
