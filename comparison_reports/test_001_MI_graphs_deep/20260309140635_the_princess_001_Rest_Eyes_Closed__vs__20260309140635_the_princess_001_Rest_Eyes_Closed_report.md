# Visual and Statistical Comparison: `20260309140635_the_princess_001_Rest Eyes Closed.easy` vs `20260309140635_the_princess_001_Rest Eyes Closed.edf`
...
- Compared duration: 20.000 s
- Mean Pearson correlation, raw: 0.5506
- Mean Pearson correlation, demeaned: 0.5506
- Mean Spearman correlation: 0.4792
- Mean RMSE, raw: 25845.293 uV
- Mean RMSE, demeaned: 134.240 uV
- Mean variance ratio, easy/edf: 100.4319

## Interpretation
- Best shape agreement after demeaning: `FC2` with Pearson=0.9752.
- Worst shape agreement after demeaning: `Pz` with Pearson=0.3215.
